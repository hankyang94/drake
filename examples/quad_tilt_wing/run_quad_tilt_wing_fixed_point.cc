        ...
        namespace quad_tilt_wing {
            ...
            namespace {
                ...
                int DoMain() {
                  ...
                  const double kThrustLowerLimit = UAV_fg/1000.0;
                  ...
                  initial_input_guess.topRows(4) = Eigen::VectorXd::Constant(4, UAV_fg/10.0);
                  initial_input_guess.bottomRows(4) = Eigen::VectorXd::Constant(4, -M_PI/6.0);
