...
//  const double kStateTol = 1e-4;
  ...
  const double kXUpperLimit = 3000;
  ...
  final_state(0) = 800;  // for initial guess
...
//                          "Print file", "/home/klytech/solver_output/traj_opt_100mps_snopt.txt");
  ...
  dirtran.SetSolverOption(solvers::SnoptSolver::id(),
                          "Print file", "/Users/Hank/solver_output/transform_0mps_50mps_snopt_new.txt");
...
//  std::ofstream file("/home/klytech/solver_output/traj_opt_sol_100mps_snopt_py.txt");
  std::ofstream file("/Users/Hank/solver_output/transform_sol_0mps_50mps_snopt_new_py.txt");
