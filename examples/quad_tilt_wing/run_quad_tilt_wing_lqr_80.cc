...
int do_main() {
  ...
  auto controller = builder.AddSystem(StabilizingLQRControllerUpright(
  ...
  for (int i = 0; i < FLAGS_simulation_trials; i++) {
    ...
    std::ofstream state_file("/Users/Hank/solver_output/lqr_80_log_state.txt");
    std::ofstream control_file("/Users/Hank/solver_output/lqr_80_log_control.txt");
    std::ofstream time_file("/Users/Hank/solver_output/lqr_80_log_time.txt");
