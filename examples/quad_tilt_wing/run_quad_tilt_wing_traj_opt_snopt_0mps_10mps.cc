...
//  const double kThetaDotLimit = M_PI/40;
  ...
  final_state(0) = 100;  // for initial guess
  final_state(2) = 20; // Z_N, try keeping the same height at final state
  final_state(6) = 10.0; // dot_X, aim for 10m/s speed
...
//                          "Print file", "/home/klytech/solver_output/traj_opt_100mps_snopt.txt");
  ...
  dirtran.SetSolverOption(solvers::SnoptSolver::id(),
                          "Print file", "/Users/Hank/solver_output/transform_0mps_10mps_snopt_test.txt");
...
//  std::ofstream file("/home/klytech/solver_output/traj_opt_sol_100mps_snopt_py.txt");
  std::ofstream file("/Users/Hank/solver_output/transform_sol_0mps_10mps_snopt_test_py.txt");
