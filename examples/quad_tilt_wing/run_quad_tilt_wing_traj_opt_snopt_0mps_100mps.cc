...
//   auto quad_tilt_wing_plant = builder.AddSystem<QuadTiltWingPlant<double>>();
  ...
  const double kMaximumTimeStep = 0.9;
...
//  const double kStateTol = 1e-4;
  ...
  const double kXUpperLimit = 5000;
  const double kYLimit = 1;
  const double kZLowerLimit = -5;
  ...
  Eigen::Vector4d u0_prop{front_prop_f, front_prop_f, rear_prop_f, rear_prop_f};
...
//  final_input << 0.0755741, 0.0755741, 0.0089271, 0.0089271, -0.0282986, -0.0282986, -0.00999279, -0.00999279;  // for 50m/s
  final_input << 0.0104247, 0.0104247, 0.010424, 0.010424, -0.00707774, -0.00707774, -0.00249736, -0.00249737;
...
//                          "Print file", "/home/klytech/solver_output/traj_opt_100mps_snopt.txt");
  ...
  dirtran.SetSolverOption(solvers::SnoptSolver::id(),
                          "Print file", "/Users/Hank/solver_output/transform_0mps_100mps_snopt_new.txt");
...
//  std::ofstream file("/home/klytech/solver_output/traj_opt_sol_100mps_snopt_py.txt");
  std::ofstream file("/Users/Hank/solver_output/transform_sol_0mps_100mps_snopt_new_py.txt");
